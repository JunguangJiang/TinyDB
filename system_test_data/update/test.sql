...
UPDATE student SET scores = 60.0 WHERE GPA < 3.4;
SELECT name, id, credits, gpa, scores from student;

-- update element that exists --
UPDATE student SET name = "new_name" WHERE id = 9;
SELECT name, id, credits, gpa, scores from student;

-- update element that doesn't exist --
UPDATE student SET name = "new_name" WHERE id = 10;
SELECT name, id, credits, gpa, scores from student;
