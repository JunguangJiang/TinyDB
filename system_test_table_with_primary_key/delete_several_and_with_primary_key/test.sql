...
delete from T where m_long = 8 and m_float = 8.0 and m_string = "8";
-- [1, 7], [9, 20] --
select * from T;

delete from T where m_long > 8 and m_float <= 16.0 and m_string != "10";
-- [1, 7], 10, [17, 20] --
select * from T;

delete from T where m_long <= 18 and m_float > 1.0 and m_string != "8";
-- 1, 19, 20 --
select * from T;
...
delete from T where m_long = 8 and m_float >= 10.0 and m_string = "9";
-- 1, 19, 20 --
select * from T;

delete from T where m_long < 8 and m_float >= 8.0 and m_string = "9";
-- 1, 19, 20 --
select * from T;

delete from T where m_long < 10 and m_float >= 9.0 and m_string != "9";
-- 1, 19, 20 --
select * from T;
-- set null --
