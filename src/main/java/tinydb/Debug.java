 ...
 * tinydb.Debug. For example, on the command line, use -Dtinydb.Debug=x,
 * or simply -Dtinydb.Debug to enable it at level 0.
...
public class Debug {
  ...
  static {
      String debug = System.getProperty("tinydb.Debug");
      if (debug == null) {
