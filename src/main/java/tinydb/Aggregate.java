...
public class Aggregate extends Operator {
    ...
    private OpIterator aggregatedChild;
    private int aField;
    private int gField;
     ...
     *         {@link tinydb.Aggregator#NO_GROUPING}
     * */
    ...
    protected Tuple fetchNext() throws TransactionAbortedException, DbException {
	    if (aggregatedChild != null && aggregatedChild.hasNext()){
    ...
    public TupleDesc getTupleDesc() {
        ...
        if (aField == Aggregator.NO_GROUPING) {
            ...
            types = new Type[] {child.getTupleDesc().getFieldType(gField), aType};
            names = new String[] {child.getTupleDesc().getFieldName(gField), aName};
        }
