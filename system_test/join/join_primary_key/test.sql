...
insert into T2 values (21, null, 0.0, 0.0, "0");
insert into T2 values (22, 0, null, 0.0, "0");
insert into T2 values (23, 0, 0.0, null, "0");
...
select * from T1 join T2 on T1.id < T2.id where T2.id < 10;

select * from T2 join T1 on T1.id <> T2.id where T1.i1 is null and T2.f2 is null;

select * from T2 join T1 on T1.id <> T2.id where T1.i1 < 3 and T2.id = 4;
