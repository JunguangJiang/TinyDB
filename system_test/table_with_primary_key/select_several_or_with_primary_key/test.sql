...
-- {6, 7, 8} --
select * from T where m_int = 8 or m_long = 7 or m_string = "6";
-- all --
select * from T where m_int != 8 or m_long != 7 or m_string != "6";
select * from T where m_int != 8 or m_long = 7 or m_string != "6";
-- [1,7], [9, 20] --
select * from T where m_int != 8 or m_long = 7 or m_string != "8";

-- all --
select * from T where m_int > 8 or m_long <= 16 or m_string != "10";
select * from T where m_int <= 18 or m_long > 1 or m_string != "8";
select * from T where m_int < 8 or m_long >= 8 or m_string = "9";
select * from T where m_int < 10 or m_long >= 9 or m_string != "9";
-- [8, 20] --
select * from T where m_int = 8 or m_long >= 10 or m_string = "9";
...
-- {6, 7, 8} --
select * from T where m_float = 8.0 or m_long = 7 or m_string = "6";
-- all --
select * from T where m_float != 8.0 or m_long != 7 or m_string != "6";
select * from T where m_float != 8.0 or m_long = 7 or m_string != "6";
-- [1,7], [9, 20] --
select * from T where m_float != 8.0 or m_long = 7 or m_string != "8";

-- all --
select * from T where m_float > 8.0 or m_long <= 16 or m_string != "10";
select * from T where m_float <= 18.0 or m_long > 1 or m_string != "8";
select * from T where m_float < 8.0 or m_long >= 8 or m_string = "9";
select * from T where m_float < 10.0 or m_long >= 9 or m_string != "9";
-- [8, 20] --
select * from T where m_float = 8.0 or m_long >= 10 or m_string = "9";
