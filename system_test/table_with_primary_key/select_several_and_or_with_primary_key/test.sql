...
-- or, and, long, int, string --
-- 6 --
select * from T where m_long = 8 and m_int = 7 or m_string = "6";
-- all --
select * from T where m_long != 8 and m_int != 7 or m_string != "6";
-- except 6 --
select * from T where m_long != 8 and m_int = 7 or m_string != "6";
-- [1,7], [9, 20] --
select * from T where m_long != 8 and m_int = 7 or m_string != "8";

-- all --
select * from T where m_long > 8 and m_int <= 16 or m_string != "10";
select * from T where m_long <= 18 and m_int > 1 or m_string != "8";
-- only 9 --
select * from T where m_long < 8 and m_int >= 8 or m_string = "9";
select * from T where m_long < 10 and m_int >= 9 or m_string = "9";
-- all --
select * from T where m_long < 10 and m_int >= 9 or m_string != "9";
-- {8, 9} --
select * from T where m_long = 8 and m_int >= 5 or m_string = "9";
