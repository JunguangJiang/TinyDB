...
insert into T values (0, 22, 0.0, null, "0");
show databases;
select * from T;
-- a database exist --

select * from T where m_int is null;
select * from T where m_long is null;
select * from T where m_float is null;
select * from T where m_double is null;
select * from T where m_string is null;

select * from T where m_int is not null;
select * from T where m_long is not null;
select * from T where m_float is not null;
select * from T where m_double is not null;
select * from T where m_string is not null;

select * from T where m_int = null;
select * from T where m_long = null;
select * from T where m_float = null;
select * from T where m_double = null;
select * from T where m_string = null;
