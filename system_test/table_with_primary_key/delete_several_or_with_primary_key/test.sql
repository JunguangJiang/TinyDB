...
delete from T where m_long = 8 or m_double = 8.0 or m_string = "8";
-- [1, 7], [9, 20] --
select * from T;

delete from T where m_long > 18 or m_double <= 3.0 or m_string = "10";
-- [4, 7], 9, [11, 18] --
select * from T;

delete from T where m_long <= 5 or m_double > 13.0 or m_string = "9";
-- 6, 7, [11, 13] --
select * from T;
