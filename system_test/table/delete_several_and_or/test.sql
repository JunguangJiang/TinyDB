...
delete from T where m_long = 8 and m_int = 7 or m_string = "6";
-- [1,5],[7,20] --
select * from T;

delete from T where m_long != 7 and m_int = 7 or m_string = "7";
-- [1,5], [8, 20] --
select * from T;

delete from T where m_long > 8 and m_int <= 11 or m_string = "10";
-- [1, 5], 8, [12, 20] --
select * from T;

delete from T where m_long <= 18 and m_int > 1 or m_string != "1";
-- 1 --
select * from T;
...
-- delete something from null table --
-- set null --
