...
update T set m_long=21 where m_long = 20;
update T set m_float = 0.0 where m_long > 17;
update T set m_double = 0.0 where m_long < 3;
update T set m_string = "changed" where m_string > "12" and m_string < "5";
update T set m_double = null where m_long > 18;
select * from T;
